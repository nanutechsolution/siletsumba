...
<body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100">
    <div x-data="appHandler()">
        <div x-ref="headerWrapper" class="fixed top-0 left-0 w-full z-50 transition-transform duration-200 will-change-transform ">
            {{-- Header --}}
            <header class="bg-white dark:bg-gray-900 shadow-md max-w-7xl mx-auto">
                @include('partials.frontend-navbar-darkmode')
            </header>

            {{-- Breaking News --}}
            @if (request()->routeIs('home') && $breakingNews->isNotEmpty())
            <div class="bg-red-600 text-white py-2 overflow-hidden mx-auto max-w-7xl">
                <div class="container mx-auto px-4 flex items-center">
                    ...
                    <div class="flex-1 overflow-hidden">
                        <div class="breaking-news whitespace-nowrap marquee">
        ...
        <main class="max-w-7xl mx-auto  py-6 {{ $mainPaddingTop }}">
            @yield('content')
        </main>
        ...
        {{-- Dark Mode Toggle --}}
        <button @click="toggleDarkMode()" class="fixed bottom-5 left-5 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white px-3 py-2 rounded-full shadow-lg z-50" aria-label="Toggle dark mode">
