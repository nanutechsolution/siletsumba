        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <button id="theme-toggle-responsive" type="button"
                    ...
                    <svg id="theme-toggle-dark-icon-responsive" class="hidden w-5 h-5 me-2" fill="currentColor"
                    ...
                    <svg id="theme-toggle-light-icon-responsive" class="hidden w-5 h-5 me-2" fill="currentColor"
                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
...
<script>
    ...
    if (localStorage.getItem('color-theme') === 'dark' || (!('color-theme' in localStorage) && window.matchMedia(
        ...
        if (themeToggleLightIconResponsive) themeToggleLightIconResponsive.classList.remove('hidden');
    } else {
        document.documentElement.classList.remove('dark');
        if (themeToggleDarkIcon) themeToggleDarkIcon.classList.remove('hidden');
        if (themeToggleDarkIconResponsive) themeToggleDarkIconResponsive.classList.remove('hidden');
    }

    // Toggle logic for desktop button
    if (themeToggleBtn) {
    ...
    // Toggle logic for responsive button
