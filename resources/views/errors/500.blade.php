...
@section('content')
    <div class="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
        ...
        {{-- Ilustrasi animasi 500 --}}
        <div class="w-64 md:w-96 mb-6 relative">
            <img src="{{ asset('images/500-character.svg') }}" alt="500 Server Error" class="w-full animate-bounce-slow">
            <span class="absolute top-2 left-2 text-sm text-gray-500 dark:text-gray-400">Oops!</span>
        </div>

        {{-- Judul --}}
        <h1 class="text-5xl font-extrabold text-red-600 mb-2">500</h1>
        <p class="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-6">
            Terjadi kesalahan di server. Mohon coba beberapa saat lagi.
        </p>
