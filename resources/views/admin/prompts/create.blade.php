        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.prompts.store') }}" method="POST" class="space-y-4">
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <textarea name="prompt_template" id="prompt_template" rows="10"
                                class="mt-1 block w-full font-mono rounded-md border-gray-300 shadow-sm" required>{{ old('prompt_template') }}</textarea>
