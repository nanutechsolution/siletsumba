        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Daftar Berita</h3>
                ...
                <div class="overflow-x-auto text-gray-900 dark:text-gray-100">
                    <table class="min-w-full bg-white dark:bg-gray-800">
                        <thead>
                            <tr>
                                <th class="py-2 px-4 border-b dark:border-gray-600 text-left">Judul</th>
                                <th class="py-2 px-4 border-b dark:border-gray-600 text-left">Kategori</th>
                        ...
                        <tbody>
                            @forelse ($articles as $article)
                                <tr>
                                    <td class="py-2 px-4 border-b dark:border-gray-700">{{ $article->title }}</td>
                                    <td class="py-2 px-4 border-b dark:border-gray-700">{{ $article->category->name }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="py-4 text-center text-gray-500">Tidak ada berita.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
