                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150">
                                        ...
                                        <td class="py-4 px-4 whitespace-nowrap text-center text-sm font-medium">
                                            <span
                                                ...
                                                {{ $user->role === 'admin' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }} dark:bg-gray-600 dark:text-gray-200">
                                                {{ ucfirst($user->role) }}
                                            </span>
                                        </td>
                                        <td class="py-4 px-4 whitespace-nowrap text-center text-sm font-medium">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow-sm">
                                ...
                                <div class="mt-4 flex items-center justify-end text-sm font-medium">
                                    ...
                                    <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-200 transition">{{ __('Hapus') }}</button>
                                    </form>
                                </div>
                            </div>
                        @empty
